 ...
 * @generated
 */
public class RecetaSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RecetaPackage.RECETA: {
				Receta receta = (Receta)theEObject;
				T result = caseReceta(receta);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecetaPackage.INGREDIENTE: {
				Ingrediente ingrediente = (Ingrediente)theEObject;
				T result = caseIngrediente(ingrediente);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RecetaPackage.INSTRUCCION: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Receta</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Receta</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseReceta(Receta object) {
		return null;
	}
